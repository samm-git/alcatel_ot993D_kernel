...
static struct mipi_dsi_phy_ctrl hx8369b_dsi_video_mode_phy_db = {
	/* DSI Bit Clock at 500 MHz, 2 lane, RGB888 */
	/* regulator ctrl reg 0-3, offset=0x02cc */
	{0x03, 0x01, 0x01, 0x00},
	/* phy timig ctrl 0-10, offset=0x0260 , important */	
	{ 0x59,0x27,0xb,0x00,0x32,0x3a,0x10,0x2b,0x1c,0x03,0x04},  // ok
	/* phy ctrl, offset=0x0290 */
	{0x7f, 0x00, 0x00, 0x00},
	/* strength, offset=0x02a0  */
	{0xbb, 0x02, 0x06, 0x00},
	/* pll control, offset=0x0204, important */
	{  0x00, 0x15, 0x31, 0xd2, 0x00, 0x40, 0x37, 0x62,	   // ok
		0x01, 0x0f, 0x07,         // 0f : 1 lane, 07: two lanes
		0x05, 0x14, 0x03, 0x0, 0x0, 0x0, 0x20, 0x0, 0x02, 0x0},
};


static int __init mipi_video_hx8369b_wvga_pt_init(void)
{
	int ret=0;
	...
	pr_debug("mipi_video_hx8369b_wvga_pt_init\n");
	...
	pinfo.clk_rate = 281000000;   // 281000000, nothing to do 
	pinfo.bl_max = 100;
	pinfo.bl_min = 1;
	pinfo.fb_num = 2;
	...
	pinfo.mipi.stream = 0; /* dma_p(=0) or dma_s(=1) */
	pinfo.mipi.mdp_trigger = DSI_CMD_TRIGGER_NONE;
	pinfo.mipi.dma_trigger = DSI_CMD_TRIGGER_SW;
	pinfo.mipi.frame_rate = 47;    // 47, ok
	
	pinfo.mipi.dsi_phy_db = &hx8369b_dsi_video_mode_phy_db;
