...
static char init_item_v1[] = { 0x60, };
static char init_item_v2[] = { 0xff, 0x83, 0x57, };
static char init_item_v3[] = { 0x03, };
static char init_item_v4[] = { 0x43, 0x06, 0x06, 0x06, };
static char init_item_v5[] = { 0x53, };
static char init_item_v6[] = { 0x01, 0x40, 0x00, 0x2a, 0x2a, 0x0d, 0x4f, };
static char init_item_v7[] = { 0x70, 0x50, 0x01, 0x3c, 0xe8, 0x08, };
static char init_item_v8[] = { 0x17, 0x00, };
static char init_item_v9[] = { 0x60};
static char init_item_v10[] = { 0x00, 0x13, 0x1a, 0x29, 0x2d, 0x41, 0x49, 0x52, 0x48, 0x41, 0x3c, 0x33, 0x30, 0x1c, 0x19, 0x03, 0x00, 0x13, 0x1a, 0x29, 0x2d, 0x41, 0x49, 0x52, 0x48, 0x41, 0x3c, 0x33, 0x31, 0x1c, 0x19, 0x03, 0x00, 0x01};
static char init_item_v11[] = { 0x40, };
static char init_item_v12[] = { 0x00, 0x15, 0x1C, 0x1C, 0x83, 0x48, };


static __inline__ void truly_spi_write_byte(char dc, uint8 data)
{
	uint32 bit;
	int bnum;
...
static __inline__ int truly_spi_write(char cmd, char *data, int num)
{
	int i;
...
{
	printk("%s Edisp_powered_up:%d display_on:%d\n", __func__,truly_state.disp_powered_up, truly_state.display_on);
	if (truly_state.disp_powered_up && !truly_state.display_on) {
		gpio_set_value_cansleep(spi_cs, 1);	/* cs high */

		truly_spi_write(0x01, NULL, 0);//soft reset
		mdelay(5);
		truly_spi_write(0x11, NULL, 0);//sleep out
		mdelay(100);
		truly_spi_write(0x3a, init_item_v1, sizeof(init_item_v1));
		truly_spi_write(0xb9, init_item_v2, sizeof(init_item_v2));
		mdelay(5);
		truly_spi_write(0xcc, init_item_v3, sizeof(init_item_v3));
		truly_spi_write(0xb3, init_item_v4, sizeof(init_item_v4));
		truly_spi_write(0xb6, init_item_v5, sizeof(init_item_v5));
		truly_spi_write(0xb1, init_item_v12, sizeof(init_item_v12));
