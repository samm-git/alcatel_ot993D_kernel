...
struct reg_addr_val_pair_struct ov7692_init_settings_array[] = {
    ...
    {0x2b, 0x08},
    {0x2c, 0x66},
    {0x15, 0x94}, // enable night mode from 4x gain
    {0x2d, 0x00},
    {0x2e, 0x00},
...
{
	{0x13, 0x00, INVMASK(0x20)},
	{0x2c, 0x00, INVMASK(0xff)},
};
...
OV7692_WREG ov7692_antibanding_auto_tbl[] =
{
	...
	{0x50, 0x99, INVMASK(0xff)},
	{0x51, 0x7f, INVMASK(0xff)},
};
