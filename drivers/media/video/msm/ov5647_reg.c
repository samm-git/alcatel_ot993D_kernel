...
struct ov5647_i2c_reg_conf ov5647_hfr_60fps_settings[] = {
    {0x3035, 0x21},
    {0x3036, 0x38},
    {0x3821, 0x07},
    {0x3820, 0x41},
...
struct ov5647_i2c_reg_conf ov5647_hfr_90fps_settings[] = {
    {0x3035, 0x11},
    {0x3036, 0x2a},
    {0x3821, 0x07},
    {0x3820, 0x41},
...
struct ov5647_reg ov5647_regs = {
	...
	.reg_hfr_60fps = &ov5647_hfr_60fps_settings[0],
	.reg_hfr_60fps_size = ARRAY_SIZE(ov5647_hfr_60fps_settings),
    .reg_hfr_90fps = &ov5647_hfr_90fps_settings[0],
    .reg_hfr_90fps_size = ARRAY_SIZE(ov5647_hfr_90fps_settings),
};
