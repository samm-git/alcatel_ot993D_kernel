...
#define BRCM_GPIO_WIFI_IRQ  40 //124 //WL_OOB_IRQ , the GPIO number of qualcomm platform, modified
...
static struct resource brcm_wifi_resources[] = {
	[0] = {
		...
		.flags          = IORESOURCE_IRQ | IORESOURCE_IRQ_HIGHLEVEL, //IORESOURCE_IRQ_LOWEDGE,
	},
};
